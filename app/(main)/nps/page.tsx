...
import { FileText, Clock, Mail, MessageCircle, Database } from 'lucide-react';
    ...
    <>
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-3">
            ...
            <Button variant="outline" onClick={() => router.push('/nps/data')} className="gap-2">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-10">
        ...
        <div className="rounded-xl border border-border bg-muted/30 px-6 py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <p className="text-[13px] font-semibold">Have feedback or questions about this data?</p>
